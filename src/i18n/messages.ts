...
const EN = {
  ...
  "wizard.note": "The default for <strong>every</strong> terminal. Give one its own below.",
  "wizard.terminals": "Terminals",
  "wizard.layout": "Layout",
  "wizard.create": "Create",
  "wizard.created": '"{name}" created',

  "panes.title": "Tool per terminal",
  "panes.pane": "Terminal {n}",
  "panes.running": "open",
  "panes.hint": "Picking an AI tool above resets all of these.",
  ...
  "shortcuts.group.workspace": "Workspaces",
  "shortcuts.group.panes": "Terminals",
  "shortcuts.group.view": "View",
  "shortcuts.newWorkspace": "New workspace",
  "shortcuts.newTerminal": "Add a terminal",
  "shortcuts.rename": "Rename the active workspace",
  "shortcuts.nextPane": "Focus the next terminal",
  "shortcuts.prevPane": "Focus the previous terminal",
  "shortcuts.closePane": "Close the focused terminal",
  "shortcuts.minimizePane": "Minimize the focused terminal",
  "shortcuts.maximizePane": "Maximize the focused terminal / back to grid",
  "shortcuts.settings": "Open or close settings",
  "shortcuts.help": "Show this list",
  "shortcuts.zoomIn": "Increase text size",
  "shortcuts.zoomOut": "Decrease text size",
  "shortcuts.zoomReset": "Reset text size",
  "shortcuts.passthrough":
    "Everything else — Ctrl+C, Esc, the arrows — goes straight to the program running in the terminal.",
...
const TR: Record<keyof typeof EN, string> = {
  ...
  "wizard.note": "<strong>Her</strong> terminalin varsayılanı. Aşağıdan tek tek değiştirebilirsin.",
  "wizard.terminals": "Terminaller",
  "wizard.layout": "Yerleşim",
  "wizard.create": "Oluştur",
  "wizard.created": '"{name}" oluşturuldu',

  "panes.title": "Terminal başına araç",
  "panes.pane": "Terminal {n}",
  "panes.running": "açık",
  "panes.hint": "Yukarıdan bir AI aracı seçmek bunların hepsini sıfırlar.",
  ...
  "shortcuts.group.workspace": "Workspace'ler",
  "shortcuts.group.panes": "Terminaller",
  "shortcuts.group.view": "Görünüm",
  "shortcuts.newWorkspace": "Yeni workspace",
  "shortcuts.newTerminal": "Terminal ekle",
  "shortcuts.rename": "Aktif workspace'i yeniden adlandır",
  "shortcuts.nextPane": "Sonraki terminale geç",
  "shortcuts.prevPane": "Önceki terminale geç",
  "shortcuts.closePane": "Odaktaki terminali kapat",
  "shortcuts.minimizePane": "Odaktaki terminali küçült",
  "shortcuts.maximizePane": "Odaktaki terminali tam ekran yap / ızgaraya dön",
  "shortcuts.settings": "Ayarları aç veya kapat",
  "shortcuts.help": "Bu listeyi göster",
  "shortcuts.zoomIn": "Yazı boyutunu büyüt",
  "shortcuts.zoomOut": "Yazı boyutunu küçült",
  "shortcuts.zoomReset": "Yazı boyutunu sıfırla",
  "shortcuts.passthrough":
    "Geri kalan her şey — Ctrl+C, Esc, ok tuşları — doğrudan terminalde çalışan programa gider.",
